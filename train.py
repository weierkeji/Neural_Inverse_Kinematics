...
if __name__ == '__main__':
    ...
    parser.add_argument('--chain-path', type=str, default="assets/digit/urdf/digit_r_arm.urdf", help='urdf chain path')     #TODO
    parser.add_argument('--train-data-path', type=str, default="data/digit/train_20000.hdf5", help='urdf chain path')       #TODO
    parser.add_argument('--test-data-path', type=str, default='data/digit/val_1000.hdf5', help='urdf chain path')           #TODO
    parser.add_argument('--num-joints', type=int, default=4, help='number of joints of the kinematic chain')                #TODO
